...
input_size = (224, 224)
labels = ['huge', 'jiangwen', 'pengyuyan', 'yueyunpeng', 'zhoudongyu', 'dilireba', 'fanbingbing', 'yaoming', 'liuyifei', 'zhoujielun']
...
if __name__ == "__main__":
    try:
        ...
        main(labels=labels, model_addr="/sd/model-38558.kmodel")
    except Exception as e:
